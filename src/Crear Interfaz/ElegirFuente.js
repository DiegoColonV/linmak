				...
				<div className='row'>
					...
					>
						<div className='card card-body'>
							Puedes escribir un nombre de fuente, un estilo, el grosor, el
							tamaño, etc.
						</div>
					</div>
				</div>
			...
			<div className='row mb-5'>
				<div className='col-md-1 col-xs-5 d-flex justify-content-center'>
					<button
						...
						onClick={() => handleStep(3, '/crear/color')}
					>
