				...
				<div className='row'>
					...
					>
						<div className='card card-body'>
							Escribe el o los colores que quieres que lleve tu página, puedes
							describir la paleta utilizando temperaturas, estaciones del año,
							sentimientos, tonos, etc.
						</div>
					</div>
				</div>
			</div>
			<div className='row mb-5'>
				<div className='col-md-1 col-xs-5 d-flex justify-content-center'>
					<button
						...
						onClick={() => handleStep(2, '/crear/estilo')}
					>
