...
function HomePage() {
	...
	return (
		<>
		<ModalHelp open={modalHelp} onClose={() => setModalHelp(false)}/>
			<div>
				<Hero openModal={()=> setModalHelp(true)} />
				<main id='main'>
						...
						<div className='container'>
							...
							<div className='row no-gutters'>
									...
									<div className='content d-flex flex-column justify-content-center'>
										<div className='row'>
											...
											<div className='col-md-6 icon-box' data-aos='fade-up' data-aos-delay={400}>
												...
												<p>Guarda tus interfaces favoritas en una carpeta y organíazalas</p>
											</div>
								...
								<div className='image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2' data-aos='fade-left' data-aos-delay={100}>
									<img src='\img\general\User-Interface-User-Experience.gif' className='img-fluid' alt='' style={{ width: '100%', objectFit: 'cover' }} />
								</div>
							</div>
						</div>
					</section>
						...
						<div className='container'>
							...
							<div className='row '>
								<div className='col-md-2 d-flex align-items-stretch justify-content-center offset-1' data-aos='fade-right' data-aos-delay={25}>
									<input className='form-control' type='text' placeholder='Botones rellenos' readOnly />
								</div>
								<div className='col-md-2 d-flex align-items-stretch justify-content-center offset-2' data-aos='fade-right' data-aos-delay={25}>
									<input className='form-control' type='text' placeholder='Bordes redondeados' readOnly />
								</div>
								<div className=' col-md-2 d-flex align-items-stretch justify-content-center offset-2' data-aos='fade-right' data-aos-delay={25}>
									<input className='form-control' type='text' placeholder='Con elevación' readOnly />
								</div>
							</div>
						</div>
					</section>
